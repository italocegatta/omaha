# test-lane-coverage-separation Specification

## Purpose
Separate coverage instrumentation from browser-heavy test lanes so coverage reports reflect only fast-lane tests (unit, integration), not browser-driven tests (e2e, bdd, visual).
