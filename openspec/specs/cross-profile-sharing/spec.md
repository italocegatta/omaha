...
Any connector request while the active profile is the Família sentinel SHALL be
rejected before credential resolution, browser/context construction, network
