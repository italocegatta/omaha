# Spec: shared-table-formatters

## Purpose

Shared pure-function module for table formatting and sign logic. Consumed by
rebalance page and portfolio page Alpine components to eliminate inline
