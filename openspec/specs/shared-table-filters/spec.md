...
Shared module for table column filter logic. Provides pure JS functions and reusable Jinja2 partial for filter panel markup, used by rebalance, PoC, and asset modal pages.
