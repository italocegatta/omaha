...
- [x] 2.1 Fix shared fixture or glue issues that affect multiple browser families.
...
- [x] 3.2 Re-run `uv run task test` and confirm full-suite green.
- [x] 3.3 Update spec text or visual baselines only for confirmed contract changes.
