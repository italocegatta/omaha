...
- User calls `@roadmap-oc` from main session.
- This `roadmap-oc` session acts as orchestrator only.
...
- `@roadmap-oc` is explicit provider-specific session entrypoint alias.
- Primary orchestrator provider: `@1-roadmap-oc`.
- Secondary orchestrator provider: `@1-roadmap-oai`.
