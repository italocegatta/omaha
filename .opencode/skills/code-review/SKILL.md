...
1. The change proposal and design from the orchestrator context: `openspec/changes/<change-id>/proposal.md` and `openspec/changes/<change-id>/design.md`.
2. The main spec linked to the slice: `openspec/specs/<slug>/spec.md`.
