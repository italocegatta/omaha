...
SELECTORS: dict[str, str] = {
    ...
    "asset_table_th_class": '[data-testid="asset-table-th-class-current"]',
    ...
    "rebalance_filter_bar": '[data-testid="rebalance-filter-bar"]',
    ...
    "rebalance_stat_grid": '[data-testid="rebalance-class-summary"]',
    ...
    "rebalance_stat_current_deviation": '[data-testid="rebalance-filter-bar"]',
...
DASHBOARD_SELECTORS: dict[str, str] = {
    ...
    not in (
        ...
        "rebalance_class_summary",
        "rebalance_filter_bar",
