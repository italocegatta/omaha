---
name: "code-review"
description: "Code review agent for one implemented slice. Use after apply to review implementation against spec and run full test suite."
tools: "read_file, glob, grep, shell_command, edit_file, activate_skill"
